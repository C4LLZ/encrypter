  ...
  document.addEventListener('DOMContentLoaded', function() {
    var link = document.getElementById('encrypt');
    var link2 = document.getElementById('decrypt')
    
    
    link.addEventListener('click', function() {
        webdevencrypt.setEncrypt('originalContent','encryptedContent','passcode')
    });

    link2.addEventListener('click', function() {
        webdevencrypt.setDecrypt('decryptInput','decryptedContent','passcode')
...
var webdevencrypt = {
    ...
    setDecrypt: function() {
                document.getElementById('decryptedContent').innerText = this.decryptCodes(document.getElementById('decryptInput').value,document.getElementById('passcode').value);
    },
